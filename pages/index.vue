...
<template>
	...
	<div class="grid grid-cols-1 xl:grid-cols-2 grid-rows-1 pl-[50px] md:pl-[150px] md:pr-[150px] mt-8 xl:mt-16">
		...
		<img v-show="colormode.preference == 'dark'" src="/images/card_logo.png" alt="My Image" class="w-90 h-96 flex place-self-center xl:w-11/12 xl:h-full" />
		<img v-show="colormode.preference != 'dark'" src="/images/card_logo_blue.png" alt="My Image" class="w-80 h-96 xl:w-11/12 xl:h-full" />
		<a href="/create"
