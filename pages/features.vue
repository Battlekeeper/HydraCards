	...
	<div class="h-full dark:bg-DarkGrey dark:text-gray-100 text-black">
	  ...
	  <div class="grid grid-cols-3 gap-8 ml-16 mt-10 mx-auto">
		<div class="w-96 h-60 rounded-md shadow dark:bg-slate-600 bg-gray-300">
		  ...
		  <div class="w-72 mx-auto text-base font-medium relative top-8 leading-normal">With a quick click you are able to save your past votes on stories to your room.</div>
		</div>
		...
		<div class="w-96 h-60 rounded-md dark:bg-slate-600 bg-gray-300 shadow">
		  ...
		  <div class="w-72 mx-auto text-base font-medium relative top-8 leading-normal">Get fast and easy to read data with our charts.</div>
		</div>
		...
		<div class="w-96 h-60 rounded-md dark:bg-slate-600 bg-gray-300 shadow">
		  ...
		  <div class="w-72 mx-auto text-base font-medium relative top-8 leading-normal">Our moderator controls are super easy and efficient to use.</div>
		</div>
		...
		<div class="w-96 h-60 rounded-md dark:bg-slate-600 bg-gray-300 shadow">
		  ...
		  <div class="w-72 mx-auto text-base font-medium relative top-8 leading-normal">When you are done saving your stories you are able to export all your data to a PDF.</div>
		</div>
		...
		<div class="w-96 h-60 rounded-md dark:bg-slate-600 bg-gray-300 shadow">
		  ...
		  <div class="w-72 mx-auto text-base font-medium relative top-8 leading-normal">HydraCards is completely free at all times, no hidden charges or fees!</div>
		</div>
	</div>
	  </div>
	</div>
